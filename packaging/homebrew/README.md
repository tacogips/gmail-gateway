...
- Formula: unsigned tarballs containing one command each:
  `bin/gmail-gateway-reader`, `bin/gmail-gateway-draft`, or
  `bin/gmail-gateway-sender`.
...
dist/homebrew/gmail-gateway-reader-<version>-darwin-arm64.tar.gz.sha256
dist/homebrew/gmail-gateway-reader-<version>-darwin-x64.tar.gz
dist/homebrew/gmail-gateway-reader-<version>-darwin-x64.tar.gz.sha256
dist/homebrew/gmail-gateway-draft-<version>-darwin-arm64.tar.gz
dist/homebrew/gmail-gateway-draft-<version>-darwin-arm64.tar.gz.sha256
dist/homebrew/gmail-gateway-draft-<version>-darwin-x64.tar.gz
dist/homebrew/gmail-gateway-draft-<version>-darwin-x64.tar.gz.sha256
dist/homebrew/gmail-gateway-sender-<version>-darwin-arm64.tar.gz
dist/homebrew/gmail-gateway-sender-<version>-darwin-arm64.tar.gz.sha256
dist/homebrew/gmail-gateway-sender-<version>-darwin-x64.tar.gz
dist/homebrew/gmail-gateway-sender-<version>-darwin-x64.tar.gz.sha256
```
...
```bash
for formula in gmail-gateway-reader gmail-gateway-draft gmail-gateway-sender; do
