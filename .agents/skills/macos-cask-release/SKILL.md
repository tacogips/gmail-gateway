...
description: Deprecated for this Swift project. Use only to recognize that the old signed Homebrew Cask workflow has been removed; do not build, sign, notarize, render, publish, or recreate a gmail-gateway Cask unless the user explicitly asks to design a new Cask workflow.
---
...
restoring the legacy single `gmail-gateway` Cask.
