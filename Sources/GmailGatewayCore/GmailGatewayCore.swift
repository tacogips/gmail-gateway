...
public enum GmailGatewayExitCode: Int32, Sendable {
    case success = 0
    case generalError = 1
...
public enum GmailGatewayErrorCode: String, Sendable {
    ...
    case mutationOutcomeUnknown = "MUTATION_OUTCOME_UNKNOWN"
...
public struct GmailGatewayCommandResult: Sendable {
    public let exitCode: Int32
    public let stdout: String
    public let stderr: String
}

public struct GmailGatewayError: Error, Sendable {
    public let message: String
    public let code: GmailGatewayErrorCode
    public let exitCode: GmailGatewayExitCode
    public let details: [String: String]

    public init(
        _ message: String,
        code: GmailGatewayErrorCode,
...
public struct GmailGatewayConfig: Sendable {
...
public struct GmailGatewayService {
...
public typealias GmailGatewayReaderService = GmailGatewayService
