...
extension GmailGatewayService {
    ...
    private func messageFileURL(for key: MessageFileDownloadKey) -> URL {
        ...
        switch key.kind {
        case .attachment:
            return directory.appendingPathComponent(gmailGatewayAttachmentStorageFilename(
...
public func gmailGatewayAttachmentStorageFilename(attachmentId: String, filename: String) -> String {
