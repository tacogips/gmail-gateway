...
func assertMessageFileLookup(_ result: GmailGatewayCommandResult) throws {
...
func downloadKey(kind: String, from result: GmailGatewayCommandResult) throws -> String {
...
func remoteAttachmentDownloadKey(from result: GmailGatewayCommandResult) throws -> String {
    let lookup = try decodeObject(result.stdout)
    let data = lookup["data"] as? [String: Any]
