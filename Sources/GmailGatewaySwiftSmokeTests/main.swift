...
func testReaderRejectsSendMutation(cleanup: inout [String]) throws {
    ...
    try assert(sendResult.exitCode == GmailGatewayExitCode.graphqlExecutionError.rawValue, "reader send mutation should fail")
...
func testSenderRoutesSendMessageToDirectSend(cleanup: inout [String]) throws {
    ...
    try assert(result.exitCode == GmailGatewayExitCode.graphqlExecutionError.rawValue, "sender should stop before provider call")
...
func testSenderAlsoRoutesCreateDraft(cleanup: inout [String]) throws {
    ...
    try assert(result.exitCode == GmailGatewayExitCode.graphqlExecutionError.rawValue, "sender draft should stop before provider call")
