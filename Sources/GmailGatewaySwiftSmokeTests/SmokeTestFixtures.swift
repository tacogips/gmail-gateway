...
func createFixture(
    ...
    let root = URL(fileURLWithPath: NSTemporaryDirectory())
        .appendingPathComponent("gmail-gateway-\(UUID().uuidString)", isDirectory: true)
...
func runCli(_ arguments: [String], env: [String: String] = [:]) -> GmailGatewayCommandResult {
    GmailGatewayCLI().run(arguments: arguments, environment: env)
}
...
func runCli(
    ...
    GmailGatewayCLI(mode: mode).run(arguments: arguments, environment: env)
}

func credentialEnv(fixture: Fixture, oauthPath: String? = nil, tokenPath: String? = nil) -> [String: String] {
    [
        GmailGatewayConfigLoader.getCredentialPathEnvVarName(
